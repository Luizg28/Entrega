...
public class TelaRemoveCliente extends JInternalFrame {
	...
	public TelaRemoveCliente(String titulo) {
		super(titulo);
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Cliente cliente = manager.find(Cliente.class, Integer.parseInt(tcId.getText()));
		...
		btnSair.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("Fechou a tela de remoção de clientes");
				dispose();
			}
		});
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(50)
						...
						.addGap(26)));
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] { lNome, tcNome, lblId, tcId });
