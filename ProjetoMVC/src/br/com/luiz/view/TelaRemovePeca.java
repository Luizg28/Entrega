...
public class TelaRemovePeca extends JInternalFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private JTextField tcDescricaoPeca; 
        private JTextField tcId;

	public TelaRemovePeca(String titulo) {
		super(titulo);
		getContentPane().setBackground(new Color(50, 205, 50));
		setBounds(100, 100, 450, 300);

		JLabel lNome = new JLabel("Descrição da peça");

		tcDescricaoPeca = new JTextField();
		tcDescricaoPeca.setColumns(10);
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Peca peca = manager.find(Peca.class, Integer.parseInt(tcId.getText()));
		...
		btnSair.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("Fechou a tela de remoção de peças");
				dispose();
			}
		});
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(tcDescricaoPeca, GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(50)
						...
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(tcDescricaoPeca, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lNome))
						.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGap(26)));
		groupLayout.linkSize(SwingConstants.VERTICAL, new Component[] { lNome, tcDescricaoPeca, lblId, tcId });
